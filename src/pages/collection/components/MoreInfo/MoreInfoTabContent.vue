...
import MoreInfoTypeTabs from "pages/collection/components/MoreInfo/MoreInfoTypeTabs/MoreInfoTypeTabs.vue";

export default {
  name: "MoreInfoTabContent",
  components: { MoreInfoTypeTabs },
  async mounted() {
    this.isAvailable = await this.lockCheck(this.pokemonInfo.apiNo);
  },
  props: {
