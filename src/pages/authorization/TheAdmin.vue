      ...
      <q-card
         ...
         <q-card-section class="q-gutter-y-md text-light">
            ...
            <div class="text-subtitle1 q-gutter-y-sm details">
               <p>Username:<br>{{ UserStore.username }}</p>
               <p>Email:<br>{{ UserStore.email }}</p>
            </div>
...
export default {
   ...
   methods: {
      ...
      async updateEmail() {
         ...
         const update = await this.UserStore.updateEmailDb({
      ...
      async updatePassword() {
         ...
         const update = await this.UserStore.updatePasswordDb({
      ...
      async deleteAccount() {
         ...
         const update = await this.UserStore.deleteAccountDb(this.deletePassword);
         if (update?.error) {
