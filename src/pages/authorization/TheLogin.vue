				...
				<div class="q-ma-xl column items-center">
					<q-card class="my-card q-px-md column items-center bg-primary">
						<q-card class="my-card-inner q-pa-sm column items-center" square>
							...
							<q-form class="column q-gutter-lg form" @submit.prevent="submitForm">
								<q-input
									v-model="email"
									type="email"
									label="E-Mail"
					...
					<base-card-inner class="inner-container">
						<form @submit.prevent="submitForm">
							...
							<div class="form-control">
								<input type="username" id="username" placeholder="Username / E-Mail" v-model.trim="email" />
							</div>
							...
							<p class="switch">Don't Have An Account? <router-link to="/register"> Sign Up Here! </router-link></p>
						</form>
					</base-card-inner>
				</base-card> -->
			</template>
