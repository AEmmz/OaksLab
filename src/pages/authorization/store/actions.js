				...
				const updateDb = await update(dexRef, {
					[pkId]: {
						...
						// },
							...
							shinyCaught: true,
							alphaCaught: true,
							shinyAlphaCaught: true,
							megaCaught: true,
							shinyMegaCaught: true,
							gigantamaxCaught: true,
							shinyGigantamaxCaught: true,
							pokerusCaught: true,
							shinyPokerusCaught: true,
							favoriteCaught: true,
						},
						count: {
							normalCount: 5,
							...
							shinyMegaCount: 30,
							gigantamaxCount: 35,
							shinyGigantamaxCount: 40,
							pokerusCount: 45,
							shinyPokerusCount: 50,
							favoriteCount: 55,
						},
					},
				});
