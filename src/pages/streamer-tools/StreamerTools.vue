  ...
  <div>
    ...
    <div class="text-center q-ma-lg flex justify-center items-center description-container text-subtitle2">
      ...
      <q-separator
        ...
        vertical/>
      <p class="description">
        Then, in your favorite streaming software, screen capture the Green Key Tracker window and apply a
        simple green key filter.</p><br/><br/>
      <q-separator
        inset
        vertical/>
      <p class="description">
        You now have a stream counter that is responsive to your DexHunt tracker. You can even use
...
import WindowPortal from "./utility/WindowPortal.vue";
